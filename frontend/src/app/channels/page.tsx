        ...
        <Shell>
            ...
            >
                ...
                <div className="card">
                    ...
                    >
                        Connect Slack to deploy an agent as a bot in your
                        workspace. Uses socket mode for real-time messaging.
                    </div>
                    <div className="form-group">
                        <div className="form-label">Bot Token</div>
                        <input
